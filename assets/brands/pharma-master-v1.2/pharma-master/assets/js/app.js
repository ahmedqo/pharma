        ...
        Footer: (text = false) => {
            const html = `
                <footer data-js-mounted="true" id="footer" class="">
                    ...
                    <section class="container mx-auto mt-4 lg:mt-8 flex flex-col lg:flex-row lg:flex-wrap gap-4 lg:gap-8 lg:items-start">
                        <div class="w-full flex flex-col gap-6 justify-center lg:flex-1">
                            <div>
                                <h1 data-translate-id="header.direction" class="text-3xl">Direction General</h1>
                        ...
                        18.4 28.3 16.65q0-1.8-1.25-3.05-1.25-1.25-3-1.25t-3.025 1.275Q19.75 14.9 19.75 16.65q0 1.8 1.275 3.05 1.275 1.25 3.025 1.25Zm-14.3 24.6V41H38.3v4.55Z"
                                ...
                                <div class="flex gap-2 flex-wrap items-center">
                                    ...
                                    <div class="flex flex-col flex-1">
                                        <a href="mailto:improt@promedplanet.com">
                                                improt@promedplanet.com
                                            </a>
                        ...
                        <div class="w-full flex flex-col gap-6 justify-center lg:flex-1">
                            <div>
                                <h1 data-translate-id="header.partner" class="text-3xl">Nos Partenaire</h1>
                                <div class="border-b-2 border-prime w-20"></div>
                            </div>
                            <div class="flex flex-col gap-4">
                        ...
                        18.4 28.3 16.65q0-1.8-1.25-3.05-1.25-1.25-3-1.25t-3.025 1.275Q19.75 14.9 19.75 16.65q0 1.8 1.275 3.05 1.275 1.25 3.025 1.25Zm-14.3 24.6V41H38.3v4.55Z"
                                ...
                                <div class="flex gap-2 flex-wrap items-center">
                                    ...
                                    <div class="flex flex-col flex-1">
                                        <a href="mailto:comercial@promedplanet.com">
                                                comercial@promedplanet.com
                                            </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div onclick="show('#vid')" class="cursor-pointer w-full flex flex-col gap-6 justify-center items-center lg:w-1/4">
